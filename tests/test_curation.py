...
from compath.curation.curation import _statement_syntax_checker, _ensure_two_pathways, _get_pathways_from_statement
...
class TestCurationParser(unittest.TestCase):
    ...
    def test_valid_syntax_examples(self):
        ...
        result_1 = _statement_syntax_checker(VALID_MAPPING_1, PATHWAY_X)
        self.assertTrue(result_1)

        result_2 = _statement_syntax_checker(VALID_MAPPING_2, PATHWAY_X)
        self.assertTrue(result_2)

        result_3 = _statement_syntax_checker(VALID_MAPPING_3, PATHWAY_X)
        self.assertTrue(result_3)

        result_4 = _statement_syntax_checker(VALID_MAPPING_4, PATHWAY_X)
        self.assertTrue(result_4)

    def test_unvalid_syntax_examples(self):
        """Testing unvalid statements"""
        result_1 = _statement_syntax_checker(INVALID_MAPPING_1, PATHWAY_X)
        self.assertFalse(result_1)

        result_2 = _statement_syntax_checker(INVALID_MAPPING_2, PATHWAY_X)
        self.assertFalse(result_2)

        result_3 = _statement_syntax_checker(VALID_MAPPING_2, 'Pathway Y')
        self.assertFalse(result_3)

        result_4 = _statement_syntax_checker(VALID_MAPPING_2, 'pathway X')
        self.assertFalse(result_4)

        result_5 = _statement_syntax_checker(VALID_MAPPING_2, 'pathway X*')
        self.assertFalse(result_5)

        result_6 = _statement_syntax_checker(INVALID_MAPPING_3, '')
        self.assertFalse(result_6)

        result_7 = _statement_syntax_checker(INVALID_MAPPING_4, PATHWAY_X)
        self.assertFalse(result_7)

        result_8 = _statement_syntax_checker(INVALID_MAPPING_5, PATHWAY_X)
        self.assertFalse(result_8)

        result_9 = _statement_syntax_checker(INVALID_MAPPING_6, PATHWAY_X)
